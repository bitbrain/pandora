...
func test_property_override() -> void:
	...
	root_property.set_default_value(entity_a, "override")
	
	assert_that(root_property.get_default_value(entity_a)).is_equal("override")


func test_property_override_persistence() -> void:
	var backend = create_object_backend() as PandoraEntityBackend
	...
	var reloaded_entity_a = backend.get_entity(entity_a.get_entity_id())
	var reloaded_root_property = reloaded_entity_a.get_entity_property("root property")
	
	assert_that(reloaded_root_property.get_default_value(reloaded_entity_a)).is_equal("override")


func test_property_override_not_affecting_others() -> void:
	var backend = create_object_backend() as PandoraEntityBackend
	...
	var root_property_a = entity_a.get_entity_property("root property")
	var root_property_b = entity_b.get_entity_property("root property")
	
	root_property_a.set_default_value(entity_a, "override")
	
	assert_that(root_property_a.get_default_value(entity_a)).is_equal("override")
	assert_that(root_property_b.get_default_value(entity_b)).is_equal("foobar")


func test_property_override_propagation() -> void:
	var backend = create_object_backend() as PandoraEntityBackend
	...
	assert_that(root_property_b.get_default_value(entity_b)).is_equal("override")

func test_property_override_override() -> void:
	var backend = create_object_backend() as PandoraEntityBackend
	...
	var root_property_b = entity_b.get_entity_property("root property")
	root_property_b.set_default_value(entity_b, "second override")
	
	assert_that(root_property_b.get_default_value(entity_b)).is_equal("second override")
